      ...
      <nav id='navigation' className='floatbar box popout'>
        <div>
          <ul>
            ...
            <li><Link to={process.env.REACT_APP_RULES_URL}>Rules</Link></li>
      ...
      <nav id='social' className='floatbar box popout'>
        <div>
          <ul>
            ...
            <li><a href={`https://www.snapchat.com/add${process.env.REACT_APP_SNAPCHAT_EXTERNAL_URL}`} target='_blank' rel='noreferrer'>Snapchat</a></li>
          </ul>
        </div>
      </nav>
    </div>
